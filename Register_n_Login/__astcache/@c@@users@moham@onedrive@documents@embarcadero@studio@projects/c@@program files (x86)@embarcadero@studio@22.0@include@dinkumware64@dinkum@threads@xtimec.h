...
_CRTIMP2P int xtime_get(xtime*, int);

 #if _WIN32_C_LIB
_CRTIMP2P long _Xtime_diff_to_millis(const xtime *);
_CRTIMP2P long _Xtime_diff_to_millis2(const xtime*, const xtime *);
_CRTIMP2P long long _Xtime_get_ticks(void);
#if defined(__CODEGEARC__)  
_CRTIMP2P long long _Xtime_get_steady_ticks(void);
_CRTIMP2P long long _Xtime_get_steady_frequency(void);
#endif
